  ...
  return (
    <section id="contact" className="py-16 px-6"
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="p-8 md:p-12 rounded-3xl mb-16 text-center"
        ...
        {/* Footer */}
        <footer className="p-8 md:p-12 rounded-3xl"
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div>
              <h4 className="font-[Poppins] font-semibold mb-4"
                  style={{ color: colors.textPrimary }}>Liens utiles</h4>
              <ul className="text-sm space-y-2">
                <li><a href="#nos-offres" className="hover:text-yellow-400 transition-colors"
                       style={{ color: colors.textMuted }}>Nos Offres</a></li>
                <li><a href="#notre-art" className="hover:text-yellow-400 transition-colors"
                       style={{ color: colors.textMuted }}>Notre Art</a></li>
                <li><a href="#contact" className="hover:text-yellow-400 transition-colors"
                       style={{ color: colors.textMuted }}>Contact</a></li>
              </ul>
            </div>
            ...
            <div>
              <h4 className="font-[Poppins] font-semibold mb-4"
                  style={{ color: colors.textPrimary }}>Contact</h4>
